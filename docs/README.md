...
la url en la que se despliega es: [https://arquisoft.github.io/dede_es6b_bis/](https://arquisoft.github.io/dede_es6b_bis/).
...
Si queremos desplegar la documentación en GitHub pages, estará accesible en [https://arquisoft.github.io/dede_es6b_bis/](https://arquisoft.github.io/dede_es6b_bis/) necesitamos ejecutar `npm run deploy`.
